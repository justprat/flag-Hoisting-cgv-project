...
int i, j = 0;
char st1[] = "Sirigannadam Gelge ";
char st2[]= "Sirigannadam Balge";
...
glLoadIdentity();
if (w <= h)
gluOrtho2D(-100.0, 100.0, -80.0 * (GLfloat)h / (GLfloat)w, 80.0 * (GLfloat)h / (GLfloat)w);
else
gluOrtho2D(-100.0 * (GLfloat)w / (GLfloat)h, 100.0 * (GLfloat)w / (GLfloat)h, -80.0, 80.0);
...
glutCreateWindow("Kannada Rajyotsava Flag Hoisting Ceremony");
